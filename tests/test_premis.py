...
def test_agent_identifier(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "agentIdentifier", fuzzy_i)


def test_agent(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "agent", fuzzy_i)


def test_event(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "event", fuzzy_i)


def test_preservation_level(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "preservationLevel", fuzzy_i)


def test_significant_properties(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "significantProperties", fuzzy_i)


def test_object_characteristics(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "objectCharacteristics", fuzzy_i)


def test_original_name(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "originalName", fuzzy_i)


def test_storage(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "storage", fuzzy_i)


def test_signature_information(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "signatureInformation", fuzzy_i)


def test_relationship(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "relationship", fuzzy_i)


def test_linking_event_identifier(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "linkingEventIdentifier", fuzzy_i)


def test_linking_rights_statement_identifier(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "linkingRightsStatementIdentifier", fuzzy_i)


def test_object(request: FixtureRequest, fuzzy_i: int):
    assert is_valid(request, "object", fuzzy_i)


def test_premis(request: FixtureRequest, fuzzy_i: int):
